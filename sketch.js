...
function preload() {
    ...
    rat_Image=loadAnimation("jerryOne.png","jerryThree.png"
    );

    Back_Ground=loadAnimation("garden.png");

   cat_Image=loadAnimation("tomOne.png");

   running=loadAnimation("tomTwo.png","tomThree.png");

   stoppedTom=loadImage("tomFour.png","jerryFour.png");
